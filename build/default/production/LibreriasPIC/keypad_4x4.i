...
# 2 "<built-in>" 2
# 1 "LibreriasPIC/keypad_4x4.c" 2

# 1 "LibreriasPIC/keypad_4x4.h" 1
...
# 6 "LibreriasPIC/keypad_4x4.h" 2
# 33 "LibreriasPIC/keypad_4x4.h"
void Key_Init(void);
void Key_Enable_Filas(uint8_t fila);
uint8_t Key_Scan_Columnas(void);
uint8_t Key_Read(void);
# 2 "LibreriasPIC/keypad_4x4.c" 2
